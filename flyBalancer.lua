...
local YSpeed =speedgroup.addText({0,20}, meta.motionY.."b/s")
speedgroup.addText({0,30}, "South-North")
local ZSpeed =speedgroup.addText({0,40}, meta.motionZ.."b/s")
speedgroup.addText({0,50}, "West-East")
local XSpeed = speedgroup.addText({0,60}, meta.motionX.."b/s")
speedgroup.addText({0,70}, "Thrust")
local ThrustSpeed = speedgroup.addText({0,80}, ACTUAL_THRUST.."%")
speedgroup.addText({0,90}, "Pitch")
local PitchSpeed = speedgroup.addText({0,100}, ACTUAL_PITCH.."degrees")
